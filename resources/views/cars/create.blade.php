            ...
            <div class="col-8">
                ...
                <form method="post" action="/cars">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="plat" placeholder="Masukkan plat" name="plat" autocomplete="off">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nohp" placeholder="Masukkan nohp" name="nohp" autocomplete="off">
                    </div>
